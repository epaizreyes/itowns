...
function featureToLine(feature, options) {
    ...
    if (feature.geometry.length > 1) {
        ...
        geom.setAttribute('position', new THREE.BufferAttribute(new Float32Array(verticesUnindexed), 3));
        //   geom.addAttribute('positionLambert93', new THREE.BufferAttribute(new Float32Array(verticesUnindexed), 3));
        geom.setAttribute('speed', new THREE.BufferAttribute(new Float32Array(speed), 1));
...
function featureToExtrudedPolygon(feature, options) {
    ...
    const geom = new THREE.BufferGeometry();
    geom.isBufferGeometry = true;
    geom.setAttribute('position', new THREE.BufferAttribute(new Float32Array(verticesWallsWithDup), 3));
    geom.setAttribute('uv', new THREE.BufferAttribute(new Float32Array(uvsWallsWithDup), 2));
    geom.setAttribute('zbottom', new THREE.BufferAttribute(new Float32Array(altitudeWalls), 1));
    if (batchIdsWalls) { geom.setAttribute('batchId', new THREE.BufferAttribute(new Float32Array(batchIdsWalls), 1)); }
    ...
    geomRoof.setAttribute('position', new THREE.BufferAttribute(new Float32Array(verticesRoofWithDup), 3));
    geomRoof.setAttribute('uv', new THREE.BufferAttribute(new Float32Array(uvsRoofWithDup), 2));
    geomRoof.setAttribute('zbottom', new THREE.BufferAttribute(new Float32Array(altitudeRoof), 1));
    if (batchIds) { geomRoof.setAttribute('batchId', new THREE.BufferAttribute(new Float32Array(batchIds), 1)); }
    ...
    geomEdges.setAttribute('position', new THREE.BufferAttribute(new Float32Array(verticesEdges), 3));
